...
| [Plan de auditoría de las fuentes](./plan-auditoria-fuentes.md) | El método: taxonomía de defectos, triple pasada ciega y errores sembrados para medir al auditor. Seis fases con criterio de salida |
| [Estado de la auditoría de fuentes](./auditoria-fuentes/ESTADO.md) | **Qué queda por hacer y en qué orden.** Fases 0 a 3 cerradas, la 4 auditada sin escribir. Es lo que hay que abrir para retomar el trabajo |
