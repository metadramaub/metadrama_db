...
| F58 | sextina · las tres composiciones | «la secuencia, unidad por unidad» dice **solo «Sextina vv. 1-39»**, que es lo que ya pone la cabecera: ni es verso a verso ni pinta la estructura | UI | son composiciones que la norma fija enteras y que no preguntan nada, así que el listado no tiene nada que añadir. *Y quizá no haga falta que lo tenga: la estructura ya está en la norma de la arquitectura* | las composiciones de extensión fija | recogido, va con la revisión del formulario |
