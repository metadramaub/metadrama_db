...
- La última migración es `20260731290000_el_pareado_es_general.sql` y está aplicada.
...
4. Corregir los defectos del [informe de conformidad](./informe-conformidad-catalogo.md).
   Quedan 20 y **ninguno se puede corregir sin una decisión del IP**: el triaje, defecto por
