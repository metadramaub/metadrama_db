...
| F45 | redondilla, y las 15 que declaran el rasgo | la norma decía «base de 8; los pies quebrados pueden medir 4 y 5» **sin decir si el quiebro es obligatorio o solo posible**: en la redondilla es una licencia y en la manriqueña es lo que la define, y se leían igual | UI | la modalidad no aparecía por su cuenta, porque un rasgo `admitida` sin límite de posiciones **no sube a la norma** —es dato de la realización—, así que ese renglón era el único sitio donde se afirmaba el quiebro y no lo calificaba | las 15 arquitecturas que declaran `pie_quebrado`, en sus tres grados | **arreglado** |
...
| F29 | novena · con quebrados | elegir **en qué verso** va el quiebro y **cuánto mide** se hace con un desplegable, y es incómodo | UI | la posición y la medida son dos elecciones sobre la misma rejilla que ya se dibuja verso a verso, y se piden en un control que no la mira | las 10 arquitecturas de F11 · F16 | recogido, va con **F14** |
