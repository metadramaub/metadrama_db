...
Informe para María Rosa Álvarez Sellers, generado el 2026-09-19. Se
...
- 2 confirmaciones de respuestas que ya hemos rellenado nosotros.
...
- **vv. 185–197** · Romance · Octosílabo. Tiene 13 versos, y un romance no puede tener un número impar: en algún punto falta o sobra un verso. Hay que localizarlo y decir si se trata de una laguna, en cuyo caso renumeraremos la obra a partir de ahí, o de un error en el rango, en cuyo caso hace falta el rango correcto.
- **vv. 198–199** · Redondilla · Octosílaba. Solo tiene 2 versos, y «Octosílaba» necesita al menos 4. Puede que el rango esté mal o que se trate de otra forma.
...
| 198–199 | Redondilla · Octosílaba | Esquema de rima | Elige en el desplegable |
...
| 4 | 185–197 | 13 | `romance_a-e` | Romance | Octosílabo | — | — | **Revisar:** Tiene 13 versos, y un romance no puede tener un número impar: en algún punto falta o sobra un verso. Hay que localizarlo y decir si se trata de una laguna, en cuyo caso renumeraremos la obra a partir de ahí, o de un error en el rango, en cuyo caso hace falta el rango correcto. | 1 derivada | rasgo + forma del padre |
| 5 | 198–199 | 2 | `redondilla` | Redondilla | Octosílaba | — | — | **Revisar:** Solo tiene 2 versos, y «Octosílaba» necesita al menos 4. Puede que el rango esté mal o que se trate de otra forma. | — | directa |
