...
- **Secuencias métricas:** 5
- **Subtipos estróficos:** 0
- **Caracterizaciones por rango:** 0

## Qué hay que consultar

- **2 secuencia(s) sin equivalencia.** Es lo que hay que decidir con el editor.
...
Resolución: 3 directas · 1 con rasgo propio · 1 por ascendencia · 0 sin destino · 0 sin forma declarada · 2 con longitud por revisar.

## Dudas, una por una

| Versos | Término actual | Qué pasa |
| --- | --- | --- |
| 185–197 (13 v) | `romance_a-e` | Ninguna arquitectura activa de «Romance» admite una secuencia de 13 versos. |
| 198–199 (2 v) | `redondilla` | Ninguna arquitectura activa de «Redondilla» admite una secuencia de 2 versos. |
