...
- 3 secuencias métricas. De ellas, 2 tienen equivalencia directa en el catálogo y 1 llevan además un rasgo (la asonancia de un romance, por ejemplo).

## Qué te pido

- 3 confirmaciones de respuestas que ya he rellenado yo.
