...
- **251 secuencias reales**, todas con forma propuesta.
- 11 no proponen arquitectura: son tramos sin forma, que no la tienen por diseño.
...
| --- | ---: | --- |
| `directa` | 136 | El término declara su destino, o lo declara algo que cuelga de él |
| `rasgo` | 71 | El término se disolvió en un rasgo y la forma la da su ascendiente |
| `ascendencia` | 44 | El término no declara destino; lo hereda de un ascendiente |
...
| --- | --- | ---: | ---: |
| `endecasilabo_suelto_puro` | `endecasilabo_suelto` | **23** | 23 |
| `octava_real_regular` | `octava_real` | **10** | 10 |
| `irregular_mixto` | `irregular` | **8** | 11 |
| `copla_real_de_pie_quebrado` | `copla_real` | **1** | 3 |
| `irregular_arte_mayor` | `irregular` | **1** | 11 |
| `irregular_arte_menor` | `irregular` | **1** | 11 |
| `cancion_de_15_versos` | `cancion_petrarquista` | 0 | 1 |
| `cancion_de_8_versos` | `cancion_petrarquista` | 0 | 1 |
| `cancion_de_9_versos` | `cancion_petrarquista` | 0 | 1 |
| `cancion_endecasilaba` | `cancion_petrarquista` | 0 | 1 |
| `cancion_sin_rima_de_esdrujulos` | `cancion_petrarquista` | 0 | 1 |
...
| `doble_sextilla` | — | 0 | 0 |
| `endecasilabo_suelto_con_pareados` | `endecasilabo_suelto` | 0 | 23 |
| `endecasilabo_suelto_con_pareados_y_sin_distico_final` | `endecasilabo_suelto` | 0 | 23 |
| `endecasilabo_suelto_de_esdrujulos` | `endecasilabo_suelto` | 0 | 23 |
| `endecasilabo_suelto_encadenado` | `endecasilabo_suelto` | 0 | 23 |
| `octava_real_de_esdrujulos` | `octava_real` | 0 | 10 |
...
| `terceto_de_esdrujulos` | `terceto` | 0 | 5 |
...
| `quintilla` | forma · Quintilla | **17** | 17 |
...
| `terceto_encadenado` | forma · Terceto encadenado | **5** | 5 |
...
| `cancion_regular_abCabCcdeeDfF` | arquitectura · Canción petrarquista · Regular de 13 versos | **1** | 1 |
| `irregular` | forma · Versificación irregular | **1** | 11 |
...
| `cancion_petrarquista` | forma · Canción petrarquista | 0 | 1 |
| `cancion_sin_rima` | arquitectura · Canción petrarquista · Sin rima, con pareado final | 0 | 1 |
...
| `endecasilabo_suelto` | forma · Endecasílabo suelto | 0 | 23 |
| `endecasilabo_suelto_puro_sin_distico_final` | arquitectura · Endecasílabo suelto · Endecasilábica | 0 | 23 |
| `lira` | forma · Lira | 0 | 0 |
...
| `octava_real` | forma · Octava real | 0 | 10 |
| `pareado_de_arte_menor` | arquitectura · Pareado · De cualquier medida | 0 | 0 |
| `quintilla_1_ababa` | esquema de rima · Tipología 1 | 0 | 17 |
| `quintilla_2_abbab` | esquema de rima · Tipología 2 | 0 | 17 |
| `quintilla_3_abaab` | esquema de rima · Tipología 3 | 0 | 17 |
| `quintilla_4_aabab` | esquema de rima · Tipología 4 | 0 | 17 |
| `quintilla_5_aabba` | esquema de rima · Tipología 5 | 0 | 17 |
| `quintilla_6_abbaa` | esquema de rima · Tipología 6 | 0 | 17 |
| `quintilla_7_ababb` | esquema de rima · Tipología 7 | 0 | 17 |
| `quintilla_8_abbba` | esquema de rima · Tipología 8 | 0 | 17 |
...
| `terceto` | forma · Terceto | 0 | 5 |
| `terceto_octosilabo` | arquitectura · Terceto encadenado · Octosilábica consonante | 0 | 0 |
| `terceto_sin_encadenar_1_AXABYB` | esquema de rima · Verso central suelto | 0 | 5 |
| `terceto_sin_encadenar_2_XAAYBB` | esquema de rima · Primer verso suelto | 0 | 5 |
