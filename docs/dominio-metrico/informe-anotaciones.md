# Lo anotado frente al catálogo de hoy

Generado por `npm run audit:anotaciones`. Una respuesta no guarda a qué pregunta
...
**492 anotaciones** —492 dentro de una obra, repartidas por 17—, con 6005 respuestas y 36 desviaciones.
