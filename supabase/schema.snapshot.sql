...
CREATE TABLE public.secuencias_metricas (
  ...
  intervencion_personajes_femeninos character varying CHECK (intervencion_personajes_femeninos::text = ANY (ARRAY['sin_intervencion'::character varying, 'exclusiva'::character varying, 'compartida'::character varying]::text[])),
  intervencion_figuras_donaire character varying CHECK (intervencion_figuras_donaire::text = ANY (ARRAY['sin_intervencion'::character varying, 'exclusiva'::character varying, 'compartida'::character varying]::text[])),
  intervencion_personajes_sobrenaturales character varying CHECK (intervencion_personajes_sobrenaturales::text = ANY (ARRAY['sin_intervencion'::character varying, 'exclusiva'::character varying, 'compartida'::character varying]::text[])),
  sinopsis text,
  created_at timestamp with time zone NOT NULL DEFAULT now(),
  updated_at timestamp with time zone NOT NULL DEFAULT now(),
