...
begin
	...
	if tg_op in ('DELETE', 'UPDATE') then
		if tg_op = 'DELETE' or old.estrofa_tipo_id is distinct from new.estrofa_tipo_id then
...
begin
	...
	if tg_op in ('DELETE', 'UPDATE') and old.categoria = 'metro' then
