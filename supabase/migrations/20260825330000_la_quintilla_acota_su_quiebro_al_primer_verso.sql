...
-- > tampoco el máximo.
--
-- Navarro Tomás documenta «la quintilla con **verso inicial** quebrado», que fue la estrofa más
-- usada por Castillejo. Dice **qué verso**, y con eso dice cuántos: uno.
--
...
begin
	...
	if v_forma is null or v_rasgo is null then
		raise exception 'Falta la forma «quintilla» o el rasgo del quiebro.';
	end if;

	foreach v_par slice 1 in array array[
		array['octosilabica_consonante', '1']
	] loop
