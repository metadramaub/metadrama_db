...
alter table public.obras
	rename column analisis_editor to observaciones;

alter table public.secuencias_metricas
	rename column observaciones to sinopsis;

comment on column public.obras.observaciones is
	'Otras observaciones del editor sobre la obra. Texto libre en markdown.';

comment on column public.obras.bibliografia is
	'Bibliografía específica sobre la métrica de la obra.';

comment on column public.secuencias_metricas.sinopsis is
	'Sinopsis argumental breve de la secuencia.';
