-- Expone la forma raíz (estrofa_forma_slug + estrofa_tipo_forma) también en
-- el bloque sinopsis_metrica del payload público, para colorear el borde de
-- cada secuencia de la sinopsis con los mismos colores que barcode/pie.
--
...
values ('20260618200000', 'ficha_sinopsis_forma_slug')
