...
-- > tampoco el máximo.
--
-- Las dos arquitecturas nombran sus versos. Con el orden 5+6, «en el modelo que fijó la forma **caen
-- en el octavo verso y en el undécimo**, los que cierran cada terceto del miembro de seis»; con el
-- orden 6+5, «los quiebros se documentan **en el tercer verso y en el sexto**».
--
-- Dos versos nombrados en cada una, y con ellos el techo.
--
...
begin
	...
	if v_forma is null or v_rasgo is null then
		raise exception 'Falta la forma «oncena» o el rasgo del quiebro.';
	end if;

	foreach v_par slice 1 in array array[
		array['quintilla_sextilla', '2'],
		array['sextilla_quintilla', '2']
	] loop
