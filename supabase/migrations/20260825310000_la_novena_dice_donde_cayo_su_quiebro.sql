-- La novena dice dónde cayó su quiebro
--
-- Paso 8c de B2, seis de siete. Toca 2 arquitecturas de 9 versos.
--
-- Las dos arquitecturas de la novena declaran el quiebro como admitido, y sus notas dicen a qué
-- miembro pasa según el orden —a la quintilla en 4+5, a la redondilla en 5+4—, pero no cuántos
-- versos pueden estarlo. Las dos ganan su pregunta, y las dos se quedan sin techo declarado.
--
...
begin
	...
	if v_forma is null then
		raise exception 'La forma «novena» no está activa.';
	end if;
	...
	foreach v_par slice 1 in array array[
		array['redondilla_quintilla', '9'],
		array['quintilla_redondilla', '9']
	] loop
