...
La guía está dividida en capítulos cortos. Puedes leerla en orden con los botones **Anterior** / **Siguiente**, o buscar una duda concreta con el buscador de la izquierda.

## Tu rol de un vistazo

Como `editor` (o `revisor`), esto es lo que puedes y no puedes hacer:
