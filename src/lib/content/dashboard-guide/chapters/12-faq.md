Dudas frecuentes que surgen al editar. Usa también el buscador de la izquierda para localizar un tema concreto.

## Veo una obra en el listado pero no me deja abrirla, ¿por qué?

Solo puedes abrir la ficha de las obras que **editas** o **revisas**. El listado "Todas las obras" te deja ver que existen (título, estado y editor asignado), pero no entrar a los datos de las que no tienes asignadas. Si quieres trabajar en una obra que no es tuya y que está sin asignar, ¡escríbenos!
...
Casi todo lo que introduces se publica en la ficha; la única excepción son los **comentarios internos**, que son privados del equipo. Ver la explicación en [Antes de empezar → Qué es público y qué es interno](/dashboard/guia/antes-de-empezar#que-es-publico-y-que-es-interno).

## ¿Cómo hago que un comentario interno se vea en la ficha pública?

Un comentario interno se publica solo si haces **las dos cosas**: al escribirlo, eliges el tipo **"observación pública"**; y marcas la casilla **"Visible en ficha pública"**. Con solo una de las dos, sigue siendo privado. Los demás tipos de comentario nunca se publican.
