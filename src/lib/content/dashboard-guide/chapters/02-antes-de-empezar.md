Antes de meterte en las pestañas de una obra, conviene tener claro qué información incorporas, qué es público y cómo decidir cuando hay dudas.
...
En la práctica, trabajamos en tres capas de información, distribuidas en varias pestañas:

1. **Identificación y contexto** de la obra (título, género, datación, edición base, autoría).
2. **Estructura y análisis métrico** (jornadas, cuadros, secuencias y caracterizaciones por rango).
3. **Tu aporte más personal**: observaciones en distintos puntos, sinopsis de cada secuencia métrica, caracterización de estas (para relacionar métrica y contenido) y bibliografía específica.
...
- al escribirlo, elige el tipo **"observación pública"** (los demás tipos nunca se publican);
- marca la casilla **"Visible en ficha pública"** del comentario.

Solo cuando se cumplen **ambas cosas** (y la obra está publicada) ese comentario aparece en la ficha. Si eliges el tipo pero no marcas la casilla, sigue siendo privado.

> [!TIP]
> ¿No sabes dónde va algo? Si es información sobre la obra que quieres que el público vea, ponla en **Observaciones**. Si es una conversación o una nota de trabajo, déjala en **comentarios internos**.
...
Todo el contenido de la obra debe quedar completo y revisado por ti antes de pasarla al estado final. Para hacerlo con más facilidad, te recomendamos este orden, que es el de los siguientes capítulos:
