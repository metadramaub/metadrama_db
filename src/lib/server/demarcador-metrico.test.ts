...
const payload = {
	forms: [
		...
		{ forma_id: 'cadena', slug: 'terceto_encadenado', nombre: 'Terceto encadenado', definicion: null, grado_especificacion: 'especifica', tipo_registro: 'forma' }
	],
	architectures: [
		...
		{ arquitectura_id: 'cadena-11', forma_id: 'cadena', slug: 'endecasilabica', nombre: 'Endecasilábica', descripcion: null, principal: true, tipo_rima_id: 'consonante', unidad_versos_min: null, unidad_versos_max: null }
	],
	metricPatterns: [
	...
	sections: [
		...
		{ seccion_id: 'cadena-terceto', arquitectura_id: 'cadena-11', seccion_padre_id: null, tipo_seccion: 'terceto', nombre: 'Terceto', orden: 1, versos_min: 3, versos_max: 3, repeticiones_min: 1, repeticiones_max: null },
		{ seccion_id: 'cadena-cierre', arquitectura_id: 'cadena-11', seccion_padre_id: null, tipo_seccion: 'serventesio', nombre: 'Serventesio', orden: 2, versos_min: 4, versos_max: 4, repeticiones_min: 0, repeticiones_max: 1 }
	],
	repetitions: [],
	traits: [],
	traitValues: [],
...
const lengthRules = [
	{ arquitectura_id: 'romance-8', arquitectura_nombre: 'Octosilábica', modulo_versos: 2, residuo_versos: 0, minimo_versos: 4, origen: 'ciclo_rima', explicacion: 'ciclos de rima completos de 2 versos', desplazamientos: [0] },
	{ arquitectura_id: 'soneto-11', arquitectura_nombre: 'Canónica', modulo_versos: 14, residuo_versos: 0, minimo_versos: 14, origen: 'secciones_fijas', explicacion: 'estructuras completas de 14 versos', desplazamientos: [0] },
	{ arquitectura_id: 'cadena-11', arquitectura_nombre: 'Endecasilábica', modulo_versos: 3, residuo_versos: 0, minimo_versos: 3, origen: 'secciones_repetibles', explicacion: 'bloques completos de 3 versos, con un cierre opcional de 4 versos', desplazamientos: [0, 4] }
];
